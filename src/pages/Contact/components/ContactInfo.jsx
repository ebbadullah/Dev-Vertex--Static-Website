          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Baloch Colony Street No 2<br />Karachi, PK 95<br />Pakistan</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">+92 (316) 029-8672</p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">dervertex@gmail.com</p>
                <p className="text-gray-600">support@devvertex.com</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-blue-200/50 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex space-x-4">
            <a href="#" className="w-10 h-10 bg-blue-100 hover:bg-blue-200 rounded-lg flex items-center justify-center transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-0.5">
